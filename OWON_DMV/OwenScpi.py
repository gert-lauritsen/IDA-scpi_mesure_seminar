...
class SCPIInstrument:
    ...
    def configure_voltage_dc_auto(self):
        """Configure DC voltage measurement with specified range."""
        self.send_command(f"CONF:VOLT:DC AUTO")

    def configure_voltage_ac_auto(self):
        """Configure AC voltage measurement with specified range."""
        self.send_command(f"CONF:VOLT:AC AUTO")

    # 🔹 Current Configuration autorange
    def configure_current_dc_auto(self):
        """Configure DC current measurement with specified range."""
        self.send_command(f"CONF:CURR:DC AUTO")

    def configure_current_ac_auto(self):
        """Configure AC current measurement with specified range."""
        self.send_command(f"CONF:CURR:AC AUTO")


    def configuration_res_auto(self):
        return self.query("CONF:RES AUTO")

    def configuration_cap_auto(self):
        return self.query("CONF:CAP AUTO")

    def configuration_freq(self):
        return self.query("CONF:FREQ")

    def configuration_per(self):
        return self.query("CONF:PER")

    def configuration_diod(self):
        return self.query("CONF:DIOD")

    def configuration_cont(self):
        return self.query("CONF:CONT")

    def configuration_temp_rtd(self):
        return self.query("CONF:TEMP:RTD")
    ...
    # Continuity
    def continuity_threshold(self):
        return self.query("CONT:THRE?")
